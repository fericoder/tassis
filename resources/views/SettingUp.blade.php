...
<div class="ttm-page-title-row"  style="background-image: url(../images/blog/2447752.jpg)!important;">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="title-box text-center">
          <div class="page-title-heading">
            <h1 class="title text-light">راه‌اندازی،تاسیسات،تجهیزات</h1>
            ...
            <div class="ttm-blog-single-content">
              <div class="entry-content">
                ...
                <blockquote>
                  ...
                  <br>o	 خدمات نگهداری تاسیسات برقی
                  <br>o	 خدمات لوله کشی تاسیسات
                  <br>o	 خدمات نگهداری،بازسازی و بهسازی آسانسور
                  <br>o	خدمات تعمیر، بازسازی و مرمت ساختمان
                  <br>o	خدمات ممیزی، ایمن سازی، اعلام و اطفای آتش
                  <br>o	 خدمات نگهداری، بازسازی و بهسازی استخر، سونا جکوزی
                  <br>o	 خدمات تخصصی نمای ساختمان
