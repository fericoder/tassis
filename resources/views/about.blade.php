...
@section('content')
        ...
        <div class="site-main">
                                ...
                                <div class="section-title with-desc clearfix">
                                    ...
                                    <div class="title-desc">
                                        <p style="direction: rtl; text-align: justify">
                                            شرکت تاسیسات ساختمان ایران "تسیس"در سال 1347 تاسیس شده است واینک با قدمت  بیش از نیم قرن با سابقه ترین وبزرگترین شرکت تاسیسات ساختمان ایران می باشد.
            ...
            <!-- team-section -->
            <section class="ttm-row team-section clearfix tasis-rtl">
                <div class="container">
                    <div class="row"><!-- row -->
                        <div class="col-lg-9 col-xl-10 col-md-9">
                            ...
                            <div class="section-title style2 clearfix">
                                <div class="title-header">
                                    <h2 class="title" style="font-family:Rezvan!important;">هیئت امنا و هیئت مدیره</h2>
                                </div>
                            </div><!-- section-title end -->
                        </div>
                    </div>
