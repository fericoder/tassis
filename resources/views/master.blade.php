                               ...
                               <div class="topbar-right text-right">
                                   ...
                                   <div class="ttm-social-links-wrapper list-inline">
                                       <ul class="social-icons">
                                           <li><a href="#" class=" tooltip-bottom" data-tooltip="فیسبوک"><i class="fa fa-facebook"></i></a>
                                           </li>
                                           <li><a href="#" class=" tooltip-bottom" data-tooltip="توییتر"><i class="fa fa-twitter"></i></a>
                                           </li>
                                           <li><a href="#" class=" tooltip-bottom" data-tooltip="Flickr"><i class="fa fa-flickr"></i></a>
                                           </li>
                                           <li><a href="#" class=" tooltip-bottom" data-tooltip="لینکدین"><i class="fa fa-linkedin"></i></a>
                                           </li>
                                       </ul>
                                   </div>
                                 ...
                                 نگران نباشید کسی ایمیل شما را نمیبیند
                                   ...
                                   <div class="social-icons circle social-hover">
                                       <ul class="list-inline">
                                           <li class="social-facebook"><a class="tooltip-top" target="_blank" href="#" data-tooltip="فیسبوک"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                           <li class="social-twitter"><a class="tooltip-top" target="_blank" href="#" data-tooltip="توییتر"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                           ...
                                           <li class="social-linkedin"><a class=" tooltip-top" target="_blank" href="#" data-tooltip="لینکدین"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                       </ul>
                                   </div>
                               </div>
                           </div>
