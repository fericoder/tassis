                                  ...
                                  <div class="featured-icon-box style6">
                                      <div class="featured-content"><!--  featured-content -->
                                          ...
                                          <div class="featured-desc"><!--  featured-desc -->
                                              <p class="mb-25">•	تعمیر و نگهداری سیستم  MEP
<br>•	آسانسور
                              ...
                              <div class="col-md-6 col-lg-3">
                                  ...
                                  <div class="featured-icon-box style6">
                                      <div class="featured-content"><!--  featured-content -->
                                          ...
                                          <div class="featured-desc"><!--  featured-desc -->
                                              <p class="mb-25">•	طراحی نظام فضای سبز
                   ...
                   <div class="row">
                       <div class="history-slide owl-carousel" data-item="4" data-nav="false" data-dots="false" data-auto="true">
                           <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                               ...
                               <div class="ttm-history-box-details">
                                   ...
                                   <div class="ttm-historybox-description tasis-byekan"><!-- description  -->
                                       1-	طراحی داخلی<br>2-	تعمیر، ترمیم، بازسازی، بهسازی و پاکسازی<br>3-	ارزیابی و ممیزی وضعیت موجود ساختمان و درصورت نیاز طراحی مقاوم
                                   </div>
                           ...
                           <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                               ...
                               <div class="ttm-history-box-border"></div><!-- ttm-history-box-border  -->
                               <div class="ttm-history-box-details ">
                                   <div class="ttm-historybox-title"><h5>مدیریت راه اندازی </h5></div><!-- historybox-title  -->
                                   <div class="ttm-historybox-description tasis-byekan"><!-- description  -->
                                     1-	آسانسور<br>2-	تعمیر، نگهداری، بازسازی و بهسازی سیستم MEP (تاسیسات مکانیکی و الکتریکی)<br>3-	نصب و نگهداری سیستم اطفاء و اعلام حریق
                                   </div>
                           ...
                           <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                               ...
                               <div class="ttm-history-box-details ">
                                   ...
                                   <div class="ttm-historybox-description tasis-byekan"><!-- description  -->
                                     1-	طراحی نظام فضای سبز – طراحی نظام آبیاری بهینه باغچه ها – گلدان ها – گلخانه ها <br>2-	بررسی منابع آب مصرفی – تامین و بهینه سازی – آب باران (آب آشامیدنی و غیرآشامیدنی)<br>3-	تصفیه فاضلاب
                                   </div>
                           ...
                           <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                               ...
                               <div class="ttm-history-box-details">
                                   ...
                                   <div class="ttm-historybox-description tasis-byekan"><!-- description  -->
1-	خدمات پارکینگ ها - خدمات خودرویی تعمیر در محل و شستشوی در محل<br>2-	خدمات بسته بندی و حمل و نقل اثاثیه<br>3-	خدمات ورزشی
                                   </div>
